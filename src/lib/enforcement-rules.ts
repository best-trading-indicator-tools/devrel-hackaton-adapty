export const QUALITY_ISSUES = {
  ...
  LONG_LENGTH_RANGE: "Long length must keep body between 10 and 22 sentences.",
  VERY_LONG_LENGTH_RANGE: "Very long length must keep body between 23 and 50 sentences.",
...
export const QUALITY_GATE_PROMPT_LINES = [
  ...
  "Respect the requested length for each post exactly: short 2-4, medium 5-9, long 10-22, very long 23-50 body sentences.",
] as const;
...
export const QUALITY_REPAIR_REQUIREMENT_LINES = [
  ...
  "Keep each post body in its requested sentence range: short 2-4, medium 5-9, long 10-22, very long 23-50.",
  "Use hyphens, commas, and periods.",
